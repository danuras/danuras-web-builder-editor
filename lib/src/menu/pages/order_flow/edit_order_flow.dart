...
class EditOrderFlow extends StatefulWidget {
  const EditOrderFlow({
    super.key,
    required this.ofc,
  ...
  static const routeName = '/order-flow/edit';
  final OrderFlowController ofc;
  final Function(OrderFlow orderFlow) action;
  final OrderFlow orderFlow;

  @override
  State<EditOrderFlow> createState() => EditOrderFlowState();
}

class EditOrderFlowState extends State<EditOrderFlow> {
  ...
  @override
  void initState() {
    stepController = TextEditingController(text: widget.orderFlow.value);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Ubah Langkah Pemesanan'),
                    ...
                    children: [
                      ...
                      CustomButton(
                        ...
                        action: () async {
                          ...
                          await widget.ofc.update(
                            orderFlowId: widget.orderFlow.id,

...
class EditCardContent2 extends StatefulWidget {
  const EditCardContent2({
    super.key,
    required this.ctc,
    required this.contentTypeId,
    required this.action,
  });
  static const routeName = '/edit-card-content-2';
  final ContentTypeController ctc;
  final int contentTypeId;
  final Function(ctm.ContentType ct) action;

  @override
  State<EditCardContent2> createState() => _EditCardContent2State();
}

class _EditCardContent2State extends State<EditCardContent2> {

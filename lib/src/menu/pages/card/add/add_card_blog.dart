...
class AddCardBlog extends StatefulWidget {
  const AddCardBlog({
    super.key,
    required this.bc,
    required this.action,
  });
  static const routeName = '/add-card-blog';
  final BlogController bc;
  final Function(Blog b) action;

  @override
  State<AddCardBlog> createState() => _AddCardBlogState();
}

class _AddCardBlogState extends State<AddCardBlog> {

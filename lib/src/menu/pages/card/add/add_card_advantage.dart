...
class AddCardAdvantage extends StatefulWidget {
  const AddCardAdvantage({
    super.key,
    required this.acc,
    required this.action,
  });
  static const routeName = '/add-card-advantage';
  final AdvantageContentController acc;
  final Function(AdvantageContent ac) action;

  @override
  State<AddCardAdvantage> createState() => _AddCardAdvantageState();
}

class _AddCardAdvantageState extends State<AddCardAdvantage> {
